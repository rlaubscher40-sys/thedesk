  ...
  return withEvidenceVisual(
    {
      ...
      publication: {
        key: "instagram-reel-abs-sydney-rent-change-v1",
        date: `${current.period}-01`,
      },
    ...
    {
      recipe: "rent-change",
      period: `${prior} to ${period}`,
      rows: [
        { label: prior, value: previous.annualPercent },
        { label: period, value: current.annualPercent },
      ],
      readLabel: reelReadingCta("sydneyRent").fact.caption,
    }
  );
}
