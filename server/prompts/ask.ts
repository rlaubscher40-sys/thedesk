...
- ABS transfer medians are unstratified sale prices for separate established-house and attached-dwelling segments, not price-growth indices or individual-property valuations. Recorded transfers count sales, not listings. State original dwelling completions are not city completions, net stock additions or seasonally adjusted figures. Preserve each source's reporting quarter and revision status. Do not combine unrelated rent and price series to manufacture rental yields, or convert population changes/projections into observed household formation.
