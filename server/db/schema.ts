...
export const editions = mysqlTable("editions", {
  ...
  /** "Last week, in review", the accountability loop. Resolves the prior
   *  edition's forward-looking calls against what actually happened this
   *  week. Generated in the background after synthesis, null for the first
   *  edition (no prior to score). */
  lookback: json("lookback").$type<Lookback | null>(),
