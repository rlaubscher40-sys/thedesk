...
Reject personalised suitability assessments, recommendations to buy, sell or hold a financial product, to select a particular loan, or to establish or switch an SMSF, even if attributed to a source. Factual descriptions of rates, policy and product features are allowed without a recommendation. A disclaimer does not cure a recommendation. Flag this as an issue on the field containing it.
