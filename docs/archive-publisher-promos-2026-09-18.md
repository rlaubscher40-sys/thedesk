...
The live check also exposed an unpunctuated standfirst joined to the next source paragraph after a promotion was removed. The follow-up inserts a full stop only when an unpunctuated lead is followed by a new capitalised sentence at that known promotion boundary. Existing punctuation and lowercase continuations are preserved. It adds no source wording or factual claim.
