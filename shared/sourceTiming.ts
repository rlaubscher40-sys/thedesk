...
export const sourceTimingSchema = z
  ...
  .superRefine((value, ctx) => {
    if ((value.publisherDateStatus === "available") !== (value.publisherPublishedAt !== null))
...
export function sourceTimingHold(input: unknown, now: Date, feedDate?: string): string | null {
  ...
  if (!recentNewsTimestamp(timing.feedReportedAt, now)) return "old-or-invalid-feed-date";
